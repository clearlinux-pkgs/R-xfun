...
Version  : 0.10
Release  : 20
URL      : https://cran.r-project.org/src/contrib/xfun_0.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xfun_0.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1569990881
