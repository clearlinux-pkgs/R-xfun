...
Version  : 0.7
Release  : 14
URL      : https://cran.r-project.org/src/contrib/xfun_0.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xfun_0.7.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557847802
