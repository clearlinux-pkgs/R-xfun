...
Version  : 0.18
Release  : 33
URL      : https://cran.r-project.org/src/contrib/xfun_0.18.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xfun_0.18.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601405622
