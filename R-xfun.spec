...
Version  : 0.9
Release  : 19
URL      : https://cran.r-project.org/src/contrib/xfun_0.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xfun_0.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568750955
