...
Version  : 0.27
Release  : 50
URL      : https://cran.r-project.org/src/contrib/xfun_0.27.tar.gz
Source0  : https://cran.r-project.org/src/contrib/xfun_0.27.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634598829
...
/usr/lib64/R/library/xfun/tests/test-cran/test-cran.R
